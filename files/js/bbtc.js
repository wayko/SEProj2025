...
$("#textchange1").html("<span id='domreg'>Domain Registration</span><span id='webdesign'>Webpage Design</span><span id='webprogramming'>Website Programming</span><span id='dfe'>Database Front End Application</span><span id='sql'>SQL</span><span id='computerrepair'>Computer Repair</span><span id='maleware'>Maleware Removal</span><span id='virus'>Virus Removal</span><span id='osinstall'>Operating System Installation</span><span id='softwareinstall'>Software Installation</span><form target='paypal' action='https://www.paypal.com/cgi-bin/webscr' method='post' id='pparea'><input type='hidden' name='cmd' value='_s-xclick'><input type='hidden' name='hosted_button_id' value='TTV2JU5X5GH96'><table><tr><td><input type='hidden' name='on0' value='Domain Services'>Domain Services</td></tr><tr><td><select name='os0'><option value='Domain Registration'>Domain Registration $15.00 USD</option><option value='Domain Registration,Webhosting'>Domain Registration,Webhosting $25.00 USD</option><option value='Domain Registration,Webhosting,Email'>Domain Registration,Webhosting &amp;Email $35.00 USD</option></select> </td></tr></table><input type='hidden' name='currency_code' value='USD'><input type='image' src='../images/shoppingcart.jpg' border='0' name='submit' alt='PayPal - The safer, easier way to pay online!'><img alt='' border='0' src='https://www.paypalobjects.com/en_US/i/scr/pixel.gif' width='1' height='1'></form>");
});
