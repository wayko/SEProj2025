...
var NavView = Backbone.View.extend({
	...
	render: function(){
		$(this.navEl).html('<li><a href = "' + link0.get('links') + '"' + 'class= ' + link0.get('classes') + '>'+ link0.get('name') + '</a></li>' 
			+ '<li><a href = "' + link1.get('links') + '"' + 'class= ' + link1.get('classes') + '>'+ link1.get('name') + '</a></li>' 
			...
			+ '<li><a href = "' + link4.get('links') + '"' + 'class= ' + link4.get('classes') + '>'+ link4.get('name') + '</a></li>');
